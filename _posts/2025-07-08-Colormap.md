...
From the [Adv. Mater.](https://advanced.onlinelibrary.wiley.com/doi/10.1002/adma.202514915) paper.

<swiper-container keyboard="true" navigation="true" pagination="true" pagination-clickable="true" pagination-dynamic-bullets="true" rewind="true">
  <swiper-slide>
  <a class="spotlight" href="/assets/img/Color_4/1.jpg">
    {% include figure.liquid loading="eager" path="assets/img/Color_4/1.jpg" class="img-fluid rounded z-depth-0" %}
  </a>
  </swiper-slide>

  <swiper-slide>
  <a class="spotlight" href="/assets/img/Color_4/2.jpg">
    {% include figure.liquid loading="eager" path="assets/img/Color_4/2.jpg" class="img-fluid rounded z-depth-0" %}
  </a>
  </swiper-slide>

  <swiper-slide>
  <a class="spotlight" href="/assets/img/Color_4/3.jpg">
    {% include figure.liquid loading="eager" path="assets/img/Color_4/3.jpg" class="img-fluid rounded z-depth-0" %}
  </a>
  </swiper-slide>

  <swiper-slide>
  <a class="spotlight" href="/assets/img/Color_4/4.jpg">
    {% include figure.liquid loading="eager" path="assets/img/Color_4/4.jpg" class="img-fluid rounded z-depth-0" %}
  </a>
  </swiper-slide>

  <swiper-slide>
  <a class="spotlight" href="/assets/img/Color_4/5.jpg">
    {% include figure.liquid loading="eager" path="assets/img/Color_4/5.jpg" class="img-fluid rounded z-depth-0" %}
  </a>
  </swiper-slide>

  <swiper-slide>
  <a class="spotlight" href="/assets/img/Color_4/6.jpg">
    {% include figure.liquid loading="eager" path="assets/img/Color_4/6.jpg" class="img-fluid rounded z-depth-0" %}
  </a>
  </swiper-slide>

  <swiper-slide>
  <a class="spotlight" href="/assets/img/Color_4/7.jpg">
    {% include figure.liquid loading="eager" path="assets/img/Color_4/7.jpg" class="img-fluid rounded z-depth-0" %}
  </a>
  </swiper-slide>

  <swiper-slide>
  <a class="spotlight" href="/assets/img/Color_4/8.jpg">
    {% include figure.liquid loading="eager" path="assets/img/Color_4/8.jpg" class="img-fluid rounded z-depth-0" %}
  </a>
  </swiper-slide>

  <swiper-slide>
  <a class="spotlight" href="/assets/img/Color_4/9.jpg">
    {% include figure.liquid loading="eager" path="assets/img/Color_4/9.jpg" class="img-fluid rounded z-depth-0" %}
  </a>
  </swiper-slide>
</swiper-container>
